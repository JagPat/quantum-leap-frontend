...
export default function Portfolio() {
    ...
    useEffect(() => {
        console.log("🔄 [Portfolio] portfolioData state changed:", {
        ...
        try {
            ...
            if (result?.status === 'success' && result?.data) {
                ...
                if ((!result.data.holdings || result.data.holdings.length === 0) && 
                    ...
                    console.log("⚠️ [Portfolio] Portfolio data is empty - this could be normal if no holdings/positions exist");
                    console.log("💡 [Portfolio] Suggestion: Check broker connection or try refreshing live data");
                }
    ...
    if (!portfolioData || (!portfolioData.holdings?.length && !portfolioData.positions?.length)) {
        console.log("🚨 [Portfolio] Rendering 'No Portfolio Data' because:", {
            portfolioData: !!portfolioData,
